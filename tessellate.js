...
var tessellate = function(vertices)
{
    debugger;
    var i;
    ...
    var ta = new Float64Array(vertices);
    ...
    Module.setValue(contours+4, p+ta.byteLength, 'i32');
    ...
    c_tessellate(ppcoordinates_out, pnverts, pptris_out, pntris, contours, contours+8);

...
tessellate.js: _begin.js _tessellate.js _middle.js tessellate_api.js _end.js
	cat _begin.js _tessellate.js  _middle.js tessellate_api.js _end.js > tessellate.js
